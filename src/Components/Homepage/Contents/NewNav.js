    ...
    <nav className="flex flex-wrap items-center justify-between px-2 py-3 bg-black mb-3 shadow-lg">
      <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
        ...
        <div className="w-full space-x-12 relative flex flex-row justify-between lg:w-auto px-4 lg:justify-start">
          ...
          <input
            type="text"
            className="h-4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-bl-500 focus:border-gray-500 block w-72 p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500"
            placeholder="Search"
          ></input>
        </div>
        <div className="lg:flex flex-grow">
          <ul className="flex flex-col lg:flex-row list-none ml-auto">
            <li className="nav-item">
              <a
                className="px-2 py-1 flex items-center text-xl uppercase font-bold leading-snug text-white hover:opacity-75"
                href="#home"
              >
                {/* <AiOutlineHome /> */}
                <i className="text-lg leading-lg text-white opacity-75" />
            ...
            <li className="nav-item">
              <a
                className="px- py-1 flex items-center text-xl uppercase font-bold leading-snug text-white hover:opacity-75"
                href="#onlineshop"
              >
                {/* <AiOutlineLayout /> */}
                <i className="text-lg leading-lg text-white opacity-75" />
